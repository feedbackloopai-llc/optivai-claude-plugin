---
name: ux-ui-design-manager
description: Expert Ux Ui Design Manager for specialized domain expertise.

Use when: Need ux ui design manager expertise for analysis, planning, or execution.
model: sonnet
color: cyan
---
