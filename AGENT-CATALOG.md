...
Comprehensive reference guide for all specialized agents in the OptivAI + FBLAI integrated plugin.

## Quick Reference

| Domain | Agent Count | Models Used |
|--------|-------------|-------------|
| Development & Engineering | 14 | Opus (6), Sonnet (8) |
| Data Quality & Engineering | 10 | Opus (6), Sonnet (4) |
| Business & Compliance | 7 | Opus (3), Sonnet (4) |
| Technical & Strategic | 7 | Opus (5), Sonnet (2) |
| GenSI Orchestration | 8 | Sonnet (8) — framework agents |
| **Total** | **38 agent files + 8 GenSI framework agents** | |
...
Expert ETL/ELT pipeline developer for Python and SQL data pipelines with PostgreSQL and external sources.

**Use when:**
- Building data ingestion pipelines
- Data transformation workflows
- Synchronization pipelines with external sources
...
Implementation developer that takes a task spec and produces complete, tested, committed code using TDD workflow. No placeholders.

**Use when:**
- Executing task specifications
- TDD implementation workflow
- Need complete, committed code from a spec

**Key capabilities:**
- TDD workflow execution
- Full feature implementation from specs
- Automated testing and commit
...
Code quality reviewer assessing correctness, security, performance, and readability. Gate 2 of 2 (runs after spec compliance passes).
...
Spec compliance reviewer verifying implementation matches task specification exactly. Gate 1 of 2.

**Use when:**
- Verifying implementation matches spec
- Pre-quality-review compliance check
- Spec adherence validation

**Key capabilities:**
- Spec compliance verification
- Implementation-to-spec matching
- Gap analysis
...
Expert SQL developer for PostgreSQL, writing complex queries, stored procedures, views, and optimizing database operations.

**Use when:**
- Complex SQL query development
- Stored procedure creation
- View design and optimization
...
Comprehensive code reviewer that validates completed project steps against the original plan and coding standards.

**Use when:**
- A major project step has been completed
- Need to validate work against the plan
- Post-implementation review of a numbered step

**Key capabilities:**
- Plan-to-implementation validation
- Coding standards enforcement
- Comprehensive step review
...
- **1.2.0** - Merged plugin versions: 38 agent files total, added PostgreSQL/Open Brain infrastructure agents
